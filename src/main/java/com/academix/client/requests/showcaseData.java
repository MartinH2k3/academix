...
public class showcaseData {
    public static void main(String[] args) {
        ...
        // create a faculty
        System.out.println(requesterFaculty.createFaculty("facrep1", "STU", "Fakulta informatiky a informacnych technologii", "Fakulta informatiky a informačných technológií Slovenskej technickej univerzity je siedmou a najmladšou fakultou Slovenskej technickej univerzity v Bratislave. ", "Informatics", "2.5", "https://www.fiit.stuba.sk/", "https://www.fiit.stuba.sk/"));
